...
exports.generateRecap = (0, https_1.onCall)({ secrets: [anthropicApiKey], invoker: "public" }, async (request) => {
    ...
    const { memories, period } = request.data;
    if (!memories || memories.length === 0) {
        throw new https_1.HttpsError("invalid-argument", "No memories provided.");
    }
...
exports.chatWithMemories = (0, https_1.onCall)({ secrets: [anthropicApiKey], invoker: "public" }, async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "Must be signed in.");
    }
    const { memories, messages } = request.data;
    if (!memories || memories.length === 0) {
        throw new https_1.HttpsError("invalid-argument", "No memories provided.");
    }
    const memoriesText = memories
